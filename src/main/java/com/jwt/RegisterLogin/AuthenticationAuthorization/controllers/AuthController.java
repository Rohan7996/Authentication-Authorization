...
public class AuthController {
    @Autowired
    private UserDetailsService userDetailsService;//getting user info

    @Autowired
    private AuthenticationManager manager;//for auth


    @Autowired
    private JwtHelper helper;//create jwt token
